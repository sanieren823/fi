...
// TODO: implement a regular from implementation

impl FiBin {
    pub fn to_string(&self) -> String { // TODO: check if the "-" is placed correctly (especially if FiBin = 0) or if it's a number between 0 > |x| > 1
